...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.forward_button = customtkinter.CTkButton(self.sidebar_frame, text="Forward", fg_color="transparent", border_width=2, text_color=("gray10", "#DCE4EE"))
        ...
        self.play_pause_btn = customtkinter.CTkButton(master=self.slider_progressbar_frame, text="Pause/Play" , fg_color="transparent", border_width=2, text_color=("gray10", "#DCE4EE"))
        self.play_pause_btn .grid(row=4, column=0, padx=(20, 10), pady=(10, 10), sticky="nsew")   
